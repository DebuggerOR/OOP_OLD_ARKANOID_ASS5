...
public class KillingBlock extends Block {
     ...
     */
    public KillingBlock(Rectangle shape, BallRemover remover) {
        super(shape, Color.RED);
    ...
    public void drawOn(DrawSurface surface) {
        ...
        if (super.getShape().getHeight() >= utils.getStdBlockHeight()) {
            ...
            surface.drawText((int) (super.getShape().getUpperLeft().getX()
                    + 0.5 * utils.getStdBlockWidth() - 6), (int) (super.getShape().getUpperLeft().getY()
                    + 0.5 * utils.getStdBlockHeight() + 7), "K", 20);
        }
    }
}